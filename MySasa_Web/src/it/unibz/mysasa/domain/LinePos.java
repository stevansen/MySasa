...
public class LinePos implements Comparable<LinePos> {
	...
	public int getSize() {
		...
		if (cdat != null) {
			long t = 300000; //5 min
			Double mult = new Double(System.currentTimeMillis() - cdat.getTime()) / new Double(t);
			mult = new Double(mult * ret);
			ret = 20-mult.intValue();
			if((System.currentTimeMillis() - cdat.getTime())>t)
				ret = 0;
		}
		return ret;
	}
